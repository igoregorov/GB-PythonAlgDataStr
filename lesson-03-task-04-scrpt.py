...
# ну, и если известен диапозон :)

# здесь храним значение элемента, который самый частый, и его частоту
# можно и две отдельные переменные использовать
max_freq = [massiv[0], 1]

# в памяти массив с частотами элементов, здесь индекс - указаталь на значение элемента из диапазона
...
# делая второй проход, от текущей позиции, до конца массива
freq = 1
index = 1
max_freq = 0
