...
# Для алгоритма v2 профилирование на массиве объемом 10.000.000 элементов показало исполнение за 2.935 секунды
# (остальное время заняла генерация массива)
# Для алгоритма v3 профилирование на массиве объемом 10.000.000 элементов показало исполнение за 0.706 секунды
# (остальное время заняла генерация массива)
#
